...
% Shao et al. 2023
% 
% We solve the dual formulation of CPSVM model given in eq. (38) of Twin SVM for conditional probability 
% estimation in binary and multiclass classification by Shao et al. 2022
...
%FunPara.kerfPara.pars=2^0; % Sigma=2^j with j belong to {-7,-6,...,6,7}
...
for i=Cl:Ch
    ...
    for j=1:Ch
        ...
        for k=1:CV
            tst=perm(k:10:m); % se debe agregar el perm, para que la división del conjunto training y test
            ...
            [Prediction,Tf,S] = cpsvm_dual_V2(Xtr, Ytr, Xt, FunPara);
